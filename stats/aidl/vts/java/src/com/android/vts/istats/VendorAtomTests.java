...
import android.hardware.google.pixel.PixelAtoms;
...
public class VendorAtomTests extends DeviceTestCase implements IBuildReceiver {
    ...
    public void testReportVendorAtomInt() throws Exception {
        ...
        ConfigUtils.uploadConfigForPushedAtom(
            getDevice(), ISTATS_TEST_PKG, PixelAtoms.Atom.TEST_VENDOR_ATOM_REPORTED_FIELD_NUMBER);

        List<EventMetricData> data = runVendorAtomDeviceTests("testReportVendorAtomInt");
        final PixelAtoms.TestVendorAtomReported vendorAtom = getVendorAtom(data);
    ...
    private PixelAtoms.TestVendorAtomReported getVendorAtom(@Nonnull List<EventMetricData> data)
        throws Exception {
        ...
        final PixelAtoms.Atom atom = PixelAtoms.Atom.parseFrom(codedis);
